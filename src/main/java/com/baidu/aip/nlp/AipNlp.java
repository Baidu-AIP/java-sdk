...
public class AipNlp extends BaseClient {
    ...
    static final int MAX_REQUEST = 500;
    static final int MAX_REQUEST_PER_HOST = 200;

    public AipNlp(String appId, String apiKey, String secretKey) {
        super(appId, apiKey, secretKey);
        OkHttpClient.Builder builder = new OkHttpClient.Builder();
        client = builder.build();
        client.dispatcher().setMaxRequests(MAX_REQUEST);
        client.dispatcher().setMaxRequestsPerHost(MAX_REQUEST_PER_HOST);
    }

    public AipNlp(String appId, String apiKey, String secretKey, @NotNull OkHttpClient okClient) {
        super(appId, apiKey, secretKey);
        client = okClient;
    }
     ...
     * @return JSONObject
     */
    public CBFutureTask lexer(String text, String requestId, HashMap<String, Object> options) {
        ...
        return AipHttpClient.post2(this.client, request);
    }
     ...
     * @return JSONObject
     */
    public CBFutureTask lexerCustom(String text, String requestId, HashMap<String, Object> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
        request.setRequestId(requestId);
     ...
     * @param requestId - 用户自定义并发请求的id,用于区分不同的请求
     * @param options - 可选参数对象，key: value都为string类型
     * options - options列表:
     *   mode 模型选择。默认值为0，可选值mode=0（对应web模型）；mode=1（对应query模型）
     * @return JSONObject
     */
    public CBFutureTask depParser(String text, String requestId, HashMap<String, Object> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
        request.setRequestId(requestId);
     ...
     * @return JSONObject
     */
    public CBFutureTask wordEmbedding(String word, String requestId, HashMap<String, Object> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
        request.setRequestId(requestId);
     ...
     * @return JSONObject
     */
    public CBFutureTask dnnlmCn(String text, String requestId, HashMap<String, Object> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
        request.setRequestId(requestId);
     ...
     * @return JSONObject
     */
    public CBFutureTask wordSimEmbedding(String word1, String word2, String requestId,
     ...
     * @return JSONObject
     */
    public CBFutureTask simnet(String text1, String text2, String requestId, HashMap<String, Object> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
        request.setRequestId(requestId);
     ...
     * @return JSONObject
     */
    public CBFutureTask commentTag(String text, ESimnetType type, String requestId, HashMap<String, Object> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
        request.setRequestId(requestId);
     ...
     * @return JSONObject
     */
    public CBFutureTask sentimentClassify(String text, String requestId, HashMap<String, Object> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
        request.setRequestId(requestId);
     ...
     * @return JSONObject
     */
    public CBFutureTask keyword(String title, String content, String requestId, HashMap<String, Object> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
        request.setRequestId(requestId);
     ...
     * @return JSONObject
     */
    public CBFutureTask topic(String title, String content, String requestId, HashMap<String, Object> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
        request.setRequestId(requestId);
     ...
     * @return JSONObject
     */
    public CBFutureTask ecnet(String text, String requestId, HashMap<String, Object> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
        request.setRequestId(requestId);
     ...
     * @return JSONObject
     */
    public CBFutureTask emotion(String text, String requestId, HashMap<String, Object> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
        request.setRequestId(requestId);
     ...
     * @return JSONObject
     */
    public CBFutureTask newsSummary(String content, int maxSummaryLen, String requestId,
                                    HashMap<String, Object> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
        request.setRequestId(requestId);
